<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/Config/Payroll_Config.master" AutoEventWireup="true" CodeBehind="Payroll_Configuration_Dashboard.aspx.cs" Inherits="Payroll_Outsourcing.GUI.Config.Payroll_Configuration_Dashboard" %>
            ...
            <div class="col-md-3 market-update-gd">
                <div class="market-update-block clr-block-3">
                    <div class="col-md-8 market-update-left">
                        ...
                        <p>Current Pay Components Count</p>
                    </div>
              ...
              <div class="col-md-3 market-update-gd">
                <div class="market-update-block clr-block-4">
                    <div class="col-md-8 market-update-left">
                        <h3>0</h3>
                        <h4>Payroll Processing Amount</h4>
                        <p>Current Payroll Amount</p>
                    </div>
                    <div class="col-md-4 market-update-right">
                        <i class="fa fa-envelope-o"></i>
                    </div>
                    ...
                    <section id="charts1" class="charts">
                        <div class="wrapper-flex">
                            ...
                            <div class="col geo_main">
                                <h3 id="geoChartTitle">Organization Chart</h3>
                                <div id="geoChart">

                          <div class="tree">
    <ul>
        <li> <a href="#">President Director <br/>Mark Sprenger</a>
            ...
            <ul>
                <li>	<a href="#">
                    ...
                    <ul>
                        <li> <a href="#">IT Engineer <br/>I Wayan Purushottama<br/>Engineer</a>

                                    <ul>
                                        <li> <a href="#">IT Support<br/>Juanda F Butar Butar<br/>Assistant Engineer</a>

                                        </li>
                                    </ul>
                                </li>
                        <li> <a href="#">IT Administrator <br/>Mikeldi Cesteros</a>
                            ...
                            <ul>
                                ...
                                <li> <a href="#" class="just-line"><br/><br/><br/></a>
                                    <li> <a href="#">IT Engineer <br/>I Wayan Purushottama<br/>Engineer</a>
                                    ...
                                    <ul>
                                        <li> <a href="#">IT Support<br/>David Alwis<br/>Assistant Engineer</a>

                                            <ul>
                                                <li> <a href="#">IT Support<br/>Nico Simanjuntak<br/>Technician</a>
